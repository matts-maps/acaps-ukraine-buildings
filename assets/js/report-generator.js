...
(function () {
  ...
  // Horizontal bar chart (Top Raions / Infra Type)
  ...
  async function generateReport() {
    ...
    try {
      ...
      if (mapImg) {
        y = addImageWithHeading(doc, "Damage Buildings per Raion", mapImg, y, margin, pageWidth, pageHeight, pageWidth - margin * 2);
      } else {
