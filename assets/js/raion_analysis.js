// Add this at the very top of raion_analysis.js to register the plugin
...
function renderBarChart(canvasId, existingInstance, labels, data, dimension) {
    ...
    return new Chart(canvas, {
        ...
        options: {
            indexAxis: 'y',
            responsive: true,
            layout: { padding: { right: 40 } }, // Extra space for labels
            plugins: { 
...
function renderDoughnutChart(canvasId, existingInstance, labels, data, dimension) {
    ...
    return new Chart(canvas, {
        ...
        options: {
            responsive: true,
            layout: { padding: 20 }, // Extra space for external labels
            plugins: { 
...
function renderTimelineBarChart(canvasId, existingInstance, labels, data, dimension) {
    ...
    return new Chart(canvas, {
        ...
        options: {
            responsive: true,
            layout: { padding: { top: 20 } }, // Space for labels above bars
            plugins: {
                legend: { display: false },
                datalabels: {
                    anchor: 'end',
